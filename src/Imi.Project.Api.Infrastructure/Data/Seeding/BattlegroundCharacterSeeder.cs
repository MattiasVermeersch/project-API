    ...
    public class BattlegroundCharacterSeeder
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<BattlegroundCharacter>().HasData(
                ...
                {
                    BattlegroundId = Guid.Parse("00000000-0000-0001-000-000000000000"),
                ...
                new BattlegroundCharacter
                {
                    BattlegroundId = Guid.Parse("00000000-0000-0003-000-000000000000"),
                    CharacterId = Guid.Parse("00000000-0000-0000-0002-000000000000")
                },
                new BattlegroundCharacter
                {
                ...
                new BattlegroundCharacter
                {
                    BattlegroundId = Guid.Parse("00000000-0000-0004-000-000000000000"),
                    CharacterId = Guid.Parse("00000000-0000-0000-0002-000000000000")
                },
                new BattlegroundCharacter
                {
                ...
                new BattlegroundCharacter
                {
                    BattlegroundId = Guid.Parse("00000000-0000-0005-000-000000000000"),
                    CharacterId = Guid.Parse("00000000-0000-0000-0002-000000000000")
                },
                new BattlegroundCharacter
                {

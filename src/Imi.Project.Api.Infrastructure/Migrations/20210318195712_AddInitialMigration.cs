    ...
    public partial class AddInitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0001-000000000000"), 0.0, 0.0, "Death Knight", false, 167, 60, "Ghortak", "Tank", new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("00000000-0000-0000-0028-000000000000"), 0.0, 0.0, "Druid", false, 152, 60, "Phandalor", "Healer", new Guid("00000000-0000-0000-0000-000000000010") },
                    { new Guid("00000000-0000-0000-0027-000000000000"), 0.0, 0.0, "Monk", false, 152, 60, "Bromir", "Dps", new Guid("00000000-0000-0000-0000-000000000009") },
                    { new Guid("00000000-0000-0000-0026-000000000000"), 0.0, 0.0, "Rogue", false, 169, 60, "Yreleth", "Dps", new Guid("00000000-0000-0000-0000-000000000009") },
                    { new Guid("00000000-0000-0000-0025-000000000000"), 0.0, 0.0, "Warrior", false, 177, 60, "GilGalad", "Tank", new Guid("00000000-0000-0000-0000-000000000009") },
                    { new Guid("00000000-0000-0000-0024-000000000000"), 0.0, 0.0, "Mage", false, 192, 60, "Coolbone", "Dps", new Guid("00000000-0000-0000-0000-000000000008") },
                    { new Guid("00000000-0000-0000-0023-000000000000"), 0.0, 0.0, "Hunter", false, 188, 60, "Umbrion", "Dps", new Guid("00000000-0000-0000-0000-000000000008") },
                    { new Guid("00000000-0000-0000-0022-000000000000"), 0.0, 0.0, "Death Knight", false, 187, 60, "Ashifal", "Dps", new Guid("00000000-0000-0000-0000-000000000008") },
                    { new Guid("00000000-0000-0000-0021-000000000000"), 0.0, 0.0, "Demon Hunter", false, 157, 60, "Malefikh", "Dps", new Guid("00000000-0000-0000-0000-000000000007") },
                    { new Guid("00000000-0000-0000-0020-000000000000"), 0.0, 0.0, "Warlock", false, 139, 60, "Morgoroth", "Dps", new Guid("00000000-0000-0000-0000-000000000007") },
                    { new Guid("00000000-0000-0000-0019-000000000000"), 0.0, 0.0, "Druid", false, 199, 60, "Eranthil", "Healer", new Guid("00000000-0000-0000-0000-000000000007") },
                    { new Guid("00000000-0000-0000-0018-000000000000"), 0.0, 0.0, "Shaman", false, 201, 60, "Baradhor", "Healer", new Guid("00000000-0000-0000-0000-000000000007") },
                    { new Guid("00000000-0000-0000-0017-000000000000"), 0.0, 0.0, "Monk", false, 201, 60, "Trech", "Healer", new Guid("00000000-0000-0000-0000-000000000006") },
                    { new Guid("00000000-0000-0000-0016-000000000000"), 0.0, 0.0, "Paladin", false, 202, 60, "Aeternus", "Healer", new Guid("00000000-0000-0000-0000-000000000006") },
                    { new Guid("00000000-0000-0000-0015-000000000000"), 0.0, 0.0, "Rogue", false, 187, 60, "Tyrigon", "Dps", new Guid("00000000-0000-0000-0000-000000000005") },
                    { new Guid("00000000-0000-0000-0014-000000000000"), 0.0, 0.0, "Priest", false, 187, 60, "Ebrothil", "Dps", new Guid("00000000-0000-0000-0000-000000000005") },
                    { new Guid("00000000-0000-0000-0013-000000000000"), 0.0, 0.0, "Shaman", false, 185, 60, "Rhamanji", "Dps", new Guid("00000000-0000-0000-0000-000000000005") },
                    { new Guid("00000000-0000-0000-0012-000000000000"), 0.0, 0.0, "Mage", false, 145, 60, "Nuremor", "Dps", new Guid("00000000-0000-0000-0000-000000000004") },
                    { new Guid("00000000-0000-0000-0011-000000000000"), 0.0, 0.0, "Monk", false, 193, 60, "Ghinin", "Tank", new Guid("00000000-0000-0000-0000-000000000004") },
                    { new Guid("00000000-0000-0000-0010-000000000000"), 0.0, 0.0, "Demon Hunter", false, 145, 60, "Aerenthil", "Dps", new Guid("00000000-0000-0000-0000-000000000004") },
                    { new Guid("00000000-0000-0000-0009-000000000000"), 0.0, 0.0, "Paladin", false, 200, 60, "Liutasil", "Tank", new Guid("00000000-0000-0000-0000-000000000003") },
                    { new Guid("00000000-0000-0000-0008-000000000000"), 0.0, 0.0, "Hunter", false, 196, 60, "Wildstrider", "Dps", new Guid("00000000-0000-0000-0000-000000000003") },
                    { new Guid("00000000-0000-0000-0007-000000000000"), 0.0, 0.0, "Warrior", false, 175, 60, "Borugor", "Dps", new Guid("00000000-0000-0000-0000-000000000003") },
                    { new Guid("00000000-0000-0000-0006-000000000000"), 0.0, 0.0, "Mage", false, 187, 60, "Tary", "Dps", new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("00000000-0000-0000-0005-000000000000"), 0.0, 0.0, "Warlock", false, 149, 60, "Elen", "Dps", new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("00000000-0000-0000-0004-000000000000"), 0.0, 0.0, "Shaman", false, 216, 60, "Yoriko", "Healer", new Guid("00000000-0000-0000-0000-000000000002") },
                    { new Guid("00000000-0000-0000-0003-000000000000"), 384.0, 192.0, "Priest", false, 131, 60, "Shiroe", "Healer", new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("00000000-0000-0000-0002-000000000000"), 0.0, 0.0, "Druid", false, 216, 60, "Bauglir", "Dps", new Guid("00000000-0000-0000-0000-000000000001") },
                    { new Guid("00000000-0000-0000-0029-000000000000"), 0.0, 0.0, "Hunter", false, 174, 60, "Myriad", "Dps", new Guid("00000000-0000-0000-0000-000000000010") },
                    { new Guid("00000000-0000-0000-0030-000000000000"), 0.0, 0.0, "Warrior", false, 210, 60, "Ithaela", "Dps", new Guid("00000000-0000-0000-0000-000000000010") }
                });
